...
// scope=failure-domain, the cluster-wide instances.placement.failure_domain.exclude list, and the
// project-wide limits.placement.hosts.max host-footprint bound.
